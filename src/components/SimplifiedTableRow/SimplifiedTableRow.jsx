...
class SimplifiedTableRow extends Component {
    ...
    render() {
        ...
        let banksDataListStyler = { fontSize: "11px", padding: "7px", background: "#dededc", border: "1px solid #999966", width: "150px" };
...
export default SimplifiedTableRow;